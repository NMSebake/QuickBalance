...
def create_database():
    ...
    # ---------------------------------------------------------
    # MOCK ACCOUNTS - 20 ENTRIES
    # ---------------------------------------------------------

    accounts = [
        ("CUST1001", "1000000001", 1575050, "Cheque"),
        ("CUST1002", "1000000002", 842075, "Savings"),
        ("CUST1003", "1000000003", 2315000, "Cheque"),
        ("CUST1004", "1000000004", 1254300, "Savings"),
        ("CUST1005", "1000000005", 675250, "Cheque"),
        ("CUST1006", "1000000006", 1899500, "Savings"),
        ("CUST1007", "1000000007", 432100, "Cheque"),
        ("CUST1008", "1000000008", 987650, "Savings"),
        ("CUST1009", "1000000009", 3425000, "Cheque"),
        ("CUST1010", "1000000010", 765430, "Savings"),
        ("CUST1011", "1000000011", 1543200, "Cheque"),
        ("CUST1012", "1000000012", 623750, "Savings"),
        ("CUST1013", "1000000013", 2899500, "Cheque"),
        ("CUST1014", "1000000014", 1125800, "Savings"),
        ("CUST1015", "1000000015", 456700, "Cheque"),
        ("CUST1016", "1000000016", 1987650, "Savings"),
        ("CUST1017", "1000000017", 754300, "Cheque"),
        ("CUST1018", "1000000018", 3214500, "Savings"),
        ("CUST1019", "1000000019", 876540, "Cheque"),
        ("CUST1020", "1000000020", 1432100, "Savings")
    ]
